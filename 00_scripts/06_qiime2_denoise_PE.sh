...
## WORKING_DIRECTORY=/home/fungi/MADCAPS_NGS/05_QIIME2/Original_reads_TUFA
## OUTPUT=/home/fungi/MADCAPS_NGS/05_QIIME2/visual/Original_reads_TUFA
## 
## # Make the directory (mkdir) only if not existe already(-p)
## mkdir -p $OUTPUT
## 
## METADATA=/home/fungi/MADCAPS_NGS/98_database_files/sample-metadata.tsv
## # negative control sample :
## #NEG_CONTROL=/home/fungi/MADCAPS_NGS/98_database_files/Negative_control_Sample_RepSeq_V4.qza
## NEG_CONTROL=/home/fungi/MADCAPS_NGS/99_contamination
## TMPDIR=/scratch_vol1
## 
...
## 
## 
## WORKING_DIRECTORY=/home/fungi/MADCAPS_NGS/05_QIIME2/Original_reads_16S_ITS_18S_negative_control
## OUTPUT=/home/fungi/MADCAPS_NGS/05_QIIME2/visual/Original_reads_16S_ITS_18S_negative_control
## 
## # Make the directory (mkdir) only if not existe already(-p)
## mkdir -p $OUTPUT
## 
...
## WORKING_DIRECTORY=/home/fungi/MADCAPS_NGS/05_QIIME2/Original_reads_16S_ITS_18S_NC
## OUTPUT=/home/fungi/MADCAPS_NGS/05_QIIME2/visual/Original_reads_16S_ITS_18S_NC
## 
## # Make the directory (mkdir) only if not existe already(-p)
## mkdir -p $OUTPUT
## 
## METADATA=/home/fungi/MADCAPS_NGS/98_database_files/sample-metadata_others_markers_NC.tsv
## # negative control sample :
## #NEG_CONTROL=/home/fungi/MADCAPS_NGS/98_database_files/Negative_control_Sample_RepSeq_V4.qza
## NEG_CONTROL=/home/fungi/MADCAPS_NGS/05_QIIME2/Original_reads_16S_ITS_18S_negative_control/core/RepSeq_negative_control.qza
## #NEG_CONTROL=/home/fungi/MADCAPS_NGS/99_contamination
## TMPDIR=/scratch_vol1
## 
## # https://chmi-sops.github.io/mydoc_qiime2.html
...
WORKING_DIRECTORY=/home/fungi/MADCAPS_NGS/05_QIIME2/Original_reads_16S_ITS_18S_Reu
OUTPUT=/home/fungi/MADCAPS_NGS/05_QIIME2/visual/Original_reads_16S_ITS_18S_Reu

# Make the directory (mkdir) only if not existe already(-p)
mkdir -p $OUTPUT

METADATA=/home/fungi/MADCAPS_NGS/98_database_files/sample-metadata_others_markers_Reu.tsv
# negative control sample :
#NEG_CONTROL=/home/fungi/MADCAPS_NGS/98_database_files/Negative_control_Sample_RepSeq_V4.qza
NEG_CONTROL=/home/fungi/MADCAPS_NGS/99_contamination
#NEG_CONTROL=/home/fungi/MADCAPS_NGS/05_QIIME2/Original_reads_16S_ITS_18S_negative_control/core/RepSeq_negative_control.qza
